  ...
  server: {
    ...
    proxy: {
      "/api": {
        ...
        changeOrigin: true, // Permet de changer l'origine de la requête pour éviter des erreurs CORS
        secure: false, // Si HTTPS pas configuré en local, cette option sur false
      },
    },
  },
});