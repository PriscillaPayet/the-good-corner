...
import { queryWhoami } from '../../api/graphql_queries.ts';
import { SIGNOUT } from '../../api/graphql_mutations.ts';

function Header() {
  //const navigate = useNavigate();

  // On récupère les données sur l'utilisateur avec useQuery
  ...
  return (
    <header className="header">
      <div className="main-menu">
        ...
        {/* Affichage des boutons en fonction de l'état de l'utilisateur */}
        {me ? (
          ...
          <>
            ...
            <Link to="/signup" className="button link-button">
              <span className="mobile-short-label">S'inscrire</span>
              <span className="desktop-long-label">S'inscrire</span>
            </Link>
          </>
        ) : null}
      </div>
